    ...
    <Layout>
      <div className="m-36 my-24 p-4">
        ...
        <div className="flex space-x-10 my-6">
          <div className="flex border border-zinc-700 w-full rounded-md"></div>
                    ...
                    >
                      <div className="flex space-x-6 items-start p-2 pb-4">
                        <div className="flex flex-col text-xs ">
                          <span>
                            {moment(order.movieSeance.startDate).format(
                              "D MMMM"
                            )}
                          </span>
                          <span>
                      ...
                      <div className="flex pt-4 space-x-2">
                        {order.seats.map((seat) => (
                          <div
                            key={seat}
                            className="flex border border-zinc-700 rounded-md items-center justify-center p-2 w-12 h-12"
                          >
                            {seat}
                          </div>
                        ))}
